    ...
    record.update(
        {
            ...
            "mesh_domain": mesh_domain_for_label(label_id),
            "mesh_domain_tag": MESH_DOMAINS[mesh_domain_for_label(label_id)],
            "interface_policy": MESH_DOMAIN_POLICIES[
                mesh_domain_for_label(label_id)
            ]["interface_policy"],
